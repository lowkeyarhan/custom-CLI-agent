...
export const tools: Tool[] = [
  ...
  },
  {
    name: "list_files",
    description:
      "List files and directories in a given path. Can recursively list subdirectories.",
    parameters: {
      type: "object",
      properties: {
        path: {
  ...
  },
  {
    name: "run_command",
    description:
      "Execute a shell command. Use this to run npm install, git commands, tests, etc.",
    parameters: {
      type: "object",
      properties: {
        command: {
